...
struct gic_dist {
	...
	volatile uint64_t group[(GICD_ISENABLER - GICD_IGROUPR) >> 2];
	volatile uint64_t set_enable[(GICD_ICENABLER - GICD_ISENABLER) >> 2];
	volatile uint64_t clear_enable[(GICD_ISPENDR - GICD_ICENABLER) >> 2];
	volatile uint64_t set_pend[(GICD_ICPENDR - GICD_ISPENDR) >> 2];
	volatile uint64_t clear_pend[(GICD_ISACTIVER - GICD_ICPENDR) >> 2];
	volatile uint64_t set_active[(GICD_ICACTIVER - GICD_ISACTIVER) >> 2];
	volatile uint64_t clear_active[(GICD_IPRIORITYR - GICD_ICACTIVER) >> 2];
	...
	volatile uint64_t cfg[(GICD_RES3 - GICD_ICFGR) >> 2];
	volatile uchar res3[GICD_NSACR - GICD_RES3];
	volatile uint64_t ns_acess_ctrl[(GICD_SGIR - GICD_NSACR) >> 2];
	volatile uint64_t sgi[(GICD_RES4 - GICD_SGIR) >> 2];
...
struct gic_cpu {
	volatile uint64_t ctrl;
	volatile uint64_t pm;
	volatile uint64_t bp;
	volatile uint64_t ack;
	volatile uint64_t eoi;
