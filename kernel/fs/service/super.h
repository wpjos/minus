...
/*
 * Note: reading filesystem blocks goes through the buffer cache; its
 * sb_bread() convenience lives in backend/bcache/sbread.h so that this
 * header (and the whole VFS core) stays free of buffer-cache types.
 */
