...
#define MMU_REGION_USER_RO      (PTE_ATTR_NORMAL | PTE_SH_INNER | PTE_AP_RO_ANY | PTE_PXN | PTE_UXN)
#define MMU_REGION_USER_DEVICE  (PTE_ATTR_DEVICE | PTE_AP_RW_ANY | PTE_PXN | PTE_UXN)
